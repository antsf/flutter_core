...
// /// and [http_cache_hive_store].
// ///
// /// This class simplifies the creation of a [DioCacheInterceptor] backed by a [HttpCacheHiveStore].
...
//   /// If Hive is not initialized via `Hive.init()`, `HttpCacheHiveStore` will use a default
...
//     this.cachePath =
//         'dio_cache', // Sensible default if Hive is initialized elsewhere
...
//   ///
//   /// This getter creates a `DioCacheInterceptor` using a [HttpCacheHiveStore]
//   /// initialized with the specified [cachePath].
//   ///
//   /// The [CacheOptions] are configured with:
//   /// - `store`: A [HttpCacheHiveStore] instance using [cachePath].
...
//   ///
//   /// This can be used to construct an absolute [cachePath] for the [HttpCacheHiveStore]
